...
export const Navigation = () => {
    ...
    const handleTrashSidebar = () => {
        document.querySelector('.trashSidebar')?.classList.toggle('hidden');
    }
        ...
        <>
            ...
            >
                <div
                    onClick={collapse}
                    role="button"
                    className={ cn( "h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 \
